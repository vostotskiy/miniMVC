                ...
                <form  id="student" class="form-horizontal" method="post">
                    <div  class="form-group required">
                        ...
                        <div class="controls col-md-8 ">
                            <input class="input-md  textinput textInput form-control" value="<?=$student->first_name;?>"  maxlength="30" name="first_name" placeholder="Choose your username" style="margin-bottom: 10px" type="text" required />
                        </div>
                    </div>
                    <div  class="form-group required">
                        <label for="last_name" class="control-label col-md-4  requiredField"> Last name<span class="asteriskField">*</span> </label>
                        <div class="controls col-md-8 ">
                            <input class="input-md  textinput textInput form-control" value="<?=$student->last_name;?>"  maxlength="30" name="last_name" placeholder="Choose your username" style="margin-bottom: 10px" type="text" required />
                        </div>
                    </div>
                    <div  class="form-group required">
